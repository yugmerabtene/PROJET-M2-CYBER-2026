...
Ce dossier est réservé au futur code source du produit DevinciWatch. Il accueillera l'implémentation correspondant au cahier des charges et à l'architecture validée.

L'architecture de référence a été déplacée dans :
