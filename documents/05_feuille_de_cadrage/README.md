...
La feuille de cadrage sert de document de pilotage synthétique entre besoin, périmètre, objectifs, risques, organisation et livrables. Elle prépare le [cahier des charges](../06_cahier_des_charges/rendu_principal.md), la [gestion de projet](../07_gestion_de_projet/rendu_principal.md) et l'[architecture](../08_architecture/rendu_principal.md).
